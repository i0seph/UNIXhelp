...
MANPATH=/usr/man/ko:/usr/local/man:/usr/X11R5/man:/usr/new/man:/usr/misc/man:/usr/man:/usr/openwin/man:/usr/lang/man
export MANPATH

# The full URL of the Man-cgi :
MANCGI='http://localhost/~joseph/UNIXhelp1.3/Scripts/man-cgi.cgi'
...
if [ $# -ne 0 ] ; then
  cat <<END
  <TITLE>UNIX »ç¿ë¼³¸í¼­ : $COMMAND ($SECTION)</TITLE>
  <h4>Âü°í: ¸¸ÀÏ ¾Æ¹«°Íµµ º¸¿©ÁöÁö ¾Ê´Â´Ù¸é <A HREF="$MANCGI?$COMMAND">¿©±â</A>¸¦ ´©¸£¼¼¿ä.</h4>
  <hr>
END
  man $SECTION $COMMAND | \
  sed \
